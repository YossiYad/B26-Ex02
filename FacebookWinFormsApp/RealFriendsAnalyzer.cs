...
{
    public class RealFriendsAnalyzer : IFriendsAnalyzer
    {
        ...
        {
            get { return m_FriendsPoints.Count > 0; }
        }
        ...
        public RealFriendsAnalyzer(User i_LoggedInUser)
        {
        ...
        public void AnalyzeInteractions()
        {
            ...
            {
                throw new Exception("Facebook API blocked access or no friends found.");
            }
